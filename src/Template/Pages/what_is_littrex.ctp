  ...
  <div class="container" style="background-color: white; margin-top: 50px">
    <div class="row">
      <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
        <div class="card">
          <img class="card-img-top" src="http://littrex.com/img/screenshots/myCourses.png">
          <div class="card-block">
            <h4 class="card-title">Easy class management</h4>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
        <div class="card">
          <img class="card-img-top" src="http://littrex.com/img/screenshots/courseView.png">
          <div class="card-block">
      ...
      <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
        <div class="card">
          <img class="card-img-top" src="http://littrex.com/img/screenshots/courseGrades.png">
          <div class="card-block">
            <h4 class="card-title">Get analyzed</h4>
          </div>
        </div>
      </div>
    </div>
