...
<section style="padding-top: 15px;">
  <nav class="navbar navbar-default">
          <h3 style="margin: 20px 0px 0px 25px">My Courses</h3>
              ...
              <div class="box box-widget widget-user-2">
                ...
                <div class="box-footer no-padding">
                      <ul class="nav nav-stacked">
                        <li><a href="#">Instructor<span class="pull-right badge bg-aqua"><?= h($course->teacher->first_name . ' ' . $course->teacher->last_name) ?></span></a></li>
